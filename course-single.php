...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>Tutor Delight : Course Single</title>
              ...
              <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
                ...
                <li><a href="login.php">SIGN IN</a></li>
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="upstudent.php">Student</a></li>
               ...
               <table class="table table-striped course_table">
                ...
                <tbody>
                  <tr>          
                    ...
                    <td><a href="profile.php">Dr. Steve Palmer</a></td>
                    <td>08:00 to 13:00</td>
                  </tr>
                  <tr>
                    <td>Matrix Overview</td>          
                    <td><a href="profile.php">Jacob</a></td>                    
                    <td>08:00 to 13:00</td>
                  </tr>
                  <tr>
                    <td>Matrix Application</td>          
                    <td><a href="profile.php">Kimberly Jones</a></td>                    
                    <td>08:00 to 13:00</td>
                  </tr>
                  <tr>
                    <td>Advanced Matrix</td>          
                    <td><a href="profile.php">Dr.Klee</a></td>                    
                    <td>08:00 to 13:00</td>
                  </tr>
                </tbody>
              </table>
