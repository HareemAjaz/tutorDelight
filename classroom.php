            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
                ...
                <li><a href="view_course.php">Course</a></li>
				  <li><a href="admin_feeInfo.php">Student Fee Dues</a></li>
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Statistices<span class="caret"></span></a>
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="graph/graph.php">Course Report</a></li>
					
                    <li><a href="graph/graph1.php">Course Averages</a></li>
              ...
              <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-3">
                  <div class="single_whyus_top wow fadeInUp">
                    ...
                    <a href="view_teacher.php"><h3>Teacher</h3></a>
                ...
                <div class="col-lg-3 col-md-3 col-sm-3">
                  <div class="single_whyus_top wow fadeInUp">
                    ...
                    <a href="view_students.php"><h3>Student</h3></a>
                    <p>when an unknown printer took a galley of type and scrambled it to make a type specimen book</p>
                  </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-3">
                  <div class="single_whyus_top wow fadeInUp">
                    ...
                    <a href="classroom.php"><h3>Class Room</h3></a>
                    <p>when an unknown printer took a galley of type and scrambled it to make a type specimen book</p>
                  </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-3">
