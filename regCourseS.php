      ...
      <div class="container">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
          <div class="aboutus_area wow fadeInLeft">
            <h2 class="titile">View Course</h2>
...
<th>Course Name</th>
		...
		<?php
		$SID = $_GET['id'];
	    $sql_sel=mysql_query("SELECT * FROM course C, enroll E , student S where S.SID like $SID and S.SID = E.SID  and E.CID=C.CID");
	    
		
       while($row=mysql_fetch_array($sql_sel))
	   { 
         $tmp_id = $row['CID'];
         $sql_sel2=mysql_query("SELECT * FROM course where CID = $tmp_id");
	  
	  $row1=mysql_fetch_assoc($sql_sel2);	  
	 // echo $tmp_id;
       ...
       ?>
	       <tr bgcolor="<?php ?>">
			...
			<h3><td><?php echo "  ".$row1['CID']; ?></td><td></h3><a href="?tag=regC&opr=pro&rs_id=<?php echo $row['CID'];?>" ><h3><?php echo "   ".$row1['Name'];?></a></td>
            </tr><?php
	    }
}
